...
static const char *mpcplay[]  = { "sh", "-c", "mpc toggle" };
static const char *mpcnext[]  = { "sh", "-c", "mpc next" };
static const char *mpcprev[]  = { "sh", "-c", "mpc previous" };
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_y,      spawn,          {.v = mpcprev } },
  { MODKEY,                       XK_u,      spawn,          {.v = mpcplay } },
  { MODKEY,                       XK_i,      spawn,          {.v = mpcnext } },

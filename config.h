...
static const char *fonts[]          = { "SF Mono:style=Regular:size=14:antialias=true" };
static const char dmenufont[]       = "SF Mono:style=Regular:size=22:antialias=true";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-p", "Run: ", "-l", "5", "-fn", dmenufont, "-i",  NULL };
